...
impl<'en> ToStream<'en> for &'en str {
    fn to_stream<E: Encoder<'en>>(&'en self, encoder: E) -> Result<E::Ok, E::Error> {
...
impl<'en> ToStream<'en> for fmt::Arguments<'en> {
    fn to_stream<E: Encoder<'en>>(&'en self, encoder: E) -> Result<E::Ok, E::Error> {
...
impl<'en, T: ToStream<'en>> ToStream<'en> for Option<T> {
    fn to_stream<E: Encoder<'en>>(&'en self, encoder: E) -> Result<E::Ok, E::Error> {
        match *self {
...
macro_rules! encode_array {
    ($($len:tt)+) => {
        $(
            impl<'en, T: ToStream<'en>> ToStream<'en> for [T; $len] {
                fn to_stream<E: Encoder<'en>>(&'en self, encoder: E) -> Result<E::Ok, E::Error> {
...
impl<'en, T: ToStream<'en>> ToStream<'en> for [T] {
    fn to_stream<E: Encoder<'en>>(&'en self, encoder: E) -> Result<E::Ok, E::Error> {
        encoder.collect_seq(self.into_iter())
    }
}
...
encode_ref!(<'en, T: ?Sized> ToStream<'en> for &'en T where T: ToStream<'en>);
encode_ref!(<'en, T: ?Sized> ToStream<'en> for &'en mut T where T: ToStream<'en>);
encode_ref!(<'en, T: ?Sized> ToStream<'en> for Box<T> where T: ToStream<'en>);
encode_ref!(<'en, T: ?Sized> ToStream<'en> for rc::Rc<T> where T: ToStream<'en>);
encode_ref!(<'en, T: ?Sized> ToStream<'en> for sync::Arc<T> where T: ToStream<'en>);
